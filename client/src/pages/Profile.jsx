...
export default function Profile() {
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <button onClick={handleShowListings} className=" text-2xl text-green-700 w-full hover:underline">Your Listings</button>
      <p className='text-red-700 mt-5 text-center'>
        {showListingsError ? 'Error showing listings' : ''}
      </p>

      {
        (sizeflag && userListings.length === 0) ?
        ( 
          <div className=' text-center text-red-700'>You don't have any listing..</div>
        ...
        {userListings.map((listing) => 
          <div key={listing._id} className="border rounded-lg p-3 flex justify-between item-center gap-4">
            ...
            <div className="flex flex-col item-center">
              <button onClick={()=>handleDeleteListing(listing._id)} className="text-red-700 uppercase hover:opacity-60">Delete</button>
      ...
      {/* {sizeflag ? '' : <p className=' text-red-700'>You don't have any listing..</p>} */}
    </div>
  )
}
